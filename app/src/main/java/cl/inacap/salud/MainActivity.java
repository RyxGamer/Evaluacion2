...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.password = findViewById(R.id.Login_contrasenia_usuario);
        ...
        this.ingresarBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (nombreUsuario.length() < 9 || nombreUsuario.length() > 10){
                    System.out.println("Aqui debe introducir el rut");
                    errores.add("El  rut debe tener  9 o 10 caracter");
                }
                ...
                if (!contienegion){
                    System.out.println("aqui ponga un  guion");
                    errores.add("El rut debe contener un guion ( - )");
                }
                if (nombreUsuario.length() > 0) {
                    switch (nombreUsuario.getText().charAt(nombreUsuario.length() - 1)) {
                        ...
                        case 'k':
                            break;
                        default:
                            errores.add("El digito verificador debe ser 0-9 o K");
                            break;
                    }
                }else{
                    errores.add("El digito verificador debe ser 0-9 o K");
